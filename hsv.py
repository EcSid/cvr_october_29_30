# #hsv
# #h - hue (цвет), s - saturation (насыщенность), v - value (яркость)
# import numpy as np
# import cv2
#
#
...
#
#
# lh = cv2.createTrackbar("lh", "mask", lh, 255, nothing)
# ls = cv2.createTrackbar("ls", "mask", ls, 255, nothing)
# lv = cv2.createTrackbar("lv", "mask", lv, 255, nothing)
# hh = cv2.createTrackbar("hh", "mask", hh, 255, nothing)
# hs = cv2.createTrackbar("hs", "mask", hs, 255, nothing)
# hv = cv2.createTrackbar("hv", "mask", hv, 255, nothing)
#
